...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, Object> consumerFactory() {
        ...
        // SECURITY FIX (Round 13 #14): Strict trusted packages - prevents deserialization attacks
        // Only allow specific TeamSync event packages, not wildcard
        props.put(JsonDeserializer.TRUSTED_PACKAGES, "com.teamsync.common.event,com.teamsync.notification.event,java.util,java.time");
