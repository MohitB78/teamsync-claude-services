...
/**
 * Security configuration for Storage Service.
 *
 * SECURITY FIX (Round 13 #15): Enhanced security configuration:
...
public class SecurityConfig {
    ...
    /**
     * SECURITY FIX (Round 13 #15): Production profiles where Swagger should be disabled.
     */
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> {
                    // SECURITY FIX (Round 13 #16): Only allow specific actuator endpoints
                    ...
                    // SECURITY FIX (Round 13 #17): Disable Swagger in production
